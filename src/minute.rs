...
pub fn get_minute(time: &str) -> Minute {
    ...
    minutes.insert("00:06", &[
        &["At ", "six minutes past midnight", ", death relieved the sufferer.", "Glenn Shirley", "West of Hell's Fringe"],
    ]);
    ...
    minutes.insert("00:08", &[
        &["\"Hour of the night!\" exclaimed the priest; \"it is day, not night, and the hour is ", "eight past midnight", "!\"", "James Pascoe", "The Brigantine"],
    ]);
    ...
    minutes.insert("00:16", &[
        &["At ", "sixteen minutes past midnight", ", Block 4 was hit and the roof set alight.", "Gavin Mortimer", "The Longest Night"],
    ]);
    ...
    minutes.insert("00:24", &[
        &["Sanders with Sutton as his gunner began their patrol at ", "12.24am", ", turning south towards Beachy Head at 10,000 ft.", "Gavin Mortimer", "The Longest Night"],
    ]);
    ...
    minutes.insert("00:28", &[
        &["The DRINK CHEER-UP COFFEE wall clock read ", "12.28", ".", "Stephen King", "11/22/63"],
    ]);
    ...
    minutes.insert("00:40", &[
        &["We sat in the car park till ", "twenty to one", "/ And now I'm engaged to Miss Joan Hunter Dunn.", "John Betjeman", "A Subaltern's Love Song"],
    ]);
    minutes.insert("00:41", &[
        &["We sat in the car park till ", "twenty to one", "/ And now I'm engaged to Miss Joan Hunter Dunn.", "John Betjeman", "A Subaltern's Love Song"],
    ]);
    ...
    minutes.insert("00:43", &[
        &["Died five minutes ago, you say? he asked. His eye went to the watch on his wrist. ", "Twelve-forty-three", ", he wrote on the blotter.", "Agatha Christie", "A Pocket Full of Rye"],
    ]);
    minutes.insert("00:44", &[
        &["Died five minutes ago, you say? he asked. His eye went to the watch on his wrist. ", "Twelve-forty-three", ", he wrote on the blotter.", "Agatha Christie", "A Pocket Full of Rye"],
    ]);
    ...
    minutes.insert("00:47", &[
        &["At ", "12:47a.m", ", Uncle Ho left us forever.", "Andrew X. Pham", "Last Night I Dreamed Of Peace"],
    ]);
    minutes.insert("00:48", &[
        &["At ", "12:47a.m", ", Uncle Ho left us forever.", "Andrew X. Pham", "Last Night I Dreamed Of Peace"],
    ]);
    minutes.insert("00:49", &[
        &["At ", "12:47a.m", ", Uncle Ho left us forever.", "Andrew X. Pham", "Last Night I Dreamed Of Peace"],
    ]);
    ...
    minutes.insert("00:58", &[
        &["It was downright shameless on his part to come visiting them, especially at night, ", "almost at one in the morning", ", after all that had happened.", "Fyodor Dostoyevsky", "The Idiot"],
    ]);
    ...
    minutes.insert("01:08", &[
        &["It was ", "1.08a.m.", " but he had left the ball at the same time as I did, and had further to travel.", "Graeme Simsion", "The Rosie Project"],
    ]);
    ...
    minutes.insert("01:16", &[
        &["At ", "sixteen past one", ", they walked into the interview room.", "Dana Stabenow", "Nothing Gold Can Stay"],
        &["From 1am to ", "1.16am", " vouched for by other two conductors.", "Agatha Christie", "Murder on the Orient Express"],
    ]);
    ...
    minutes.insert("01:22", &[
        &["It was ", "1:22", " when we found Dad's grave.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    ...
    minutes.insert("01:26", &[
        &["When I reached the stop and got off, it was already ", "one twenty-six A.M.", " by the bus's own clock. I had been gone over ten hours.", "Tanith Lee", "The Silver Metal Lover"],
    ]);
    minutes.insert("01:27", &[
        &["At ", "twenty-seven minutes past one", " she felt as if she was levitating out of her body.", "Deon Meyer", "Trackers"],
    ]);
    ...
    minutes.insert("01:29", &[
        &["He exited the men's room at ", "one-twenty-nine A.M.", "", "William Edmund Butterworth", "The Narc"],
    ]);
    ...
    minutes.insert("01:33", &[
        &["He looked at his watch. ", "One-thirty-three a.m.", " He had been asleep on this bench for over an hour and a half.", "Kat Fox", "Skeletons"],
    ]);
    minutes.insert("01:34", &[
        &["He looked at his watch. ", "One-thirty-three a.m.", " He had been asleep on this bench for over an hour and a half.", "Kat Fox", "Skeletons"],
    ]);
    minutes.insert("01:35", &[
        &["He looked at his watch. ", "One-thirty-three a.m.", " He had been asleep on this bench for over an hour and a half.", "Kat Fox", "Skeletons"],
    ]);
    minutes.insert("01:36", &[
        &["He looked at his watch. ", "One-thirty-three a.m.", " He had been asleep on this bench for over an hour and a half.", "Kat Fox", "Skeletons"],
    ]);
    minutes.insert("01:37", &[
        &["He looked at his watch. ", "One-thirty-three a.m.", " He had been asleep on this bench for over an hour and a half.", "Kat Fox", "Skeletons"],
    ]);
    ...
    minutes.insert("01:40", &[
        &["March twelfth, ", "one-forty am", ", she leaves a group of drinking buddies to catch a bus home. She never makes it.", "Kathy Reichs", "Bones to Ashes"],
    ]);
    minutes.insert("01:41", &[
        &["March twelfth, ", "one-forty am", ", she leaves a group of drinking buddies to catch a bus home. She never makes it.", "Kathy Reichs", "Bones to Ashes"],
    ]);
    minutes.insert("01:42", &[
        &["March twelfth, ", "one-forty am", ", she leaves a group of drinking buddies to catch a bus home. She never makes it.", "Kathy Reichs", "Bones to Ashes"],
    ]);
    minutes.insert("01:43", &[
        &["March twelfth, ", "one-forty am", ", she leaves a group of drinking buddies to catch a bus home. She never makes it.", "Kathy Reichs", "Bones to Ashes"],
    ]);
    ...
    minutes.insert("02:18", &[
        &["It was ", "2:18 in the morning", ", and Donna could see no one else in any other office working so late.", "Jane Smiley", "Moo"],
    ]);
    minutes.insert("02:19", &[
        &["It was ", "2:18 in the morning", ", and Donna could see no one else in any other office working so late.", "Jane Smiley", "Moo"],
    ]);
    ...
    minutes.insert("02:25", &[
        &["You see it is time: ", "2.25am.", " You get out of bed.", "David Peace", "Nineteen Eighty-Three: The Red Riding Quartet, Book Four"],
    ]);
    minutes.insert("02:26", &[
        &["Listened to a voicemail message left at ", "2.26am", " by Claude.", "Richard Mason", "The Lighted Rooms"],
    ]);
    minutes.insert("02:27", &[
        &["The moon didn’t shine again until ", "2.27am.", " It was enough to show Wallander that he was positioned some distance below the tree.", "Henning Mankell", "One Step Behind"],
    ]);
    minutes.insert("02:28", &[
        &["", "2.28am", ": Ran out of sheep and began counting other farmyard animals.", "Mike Gayle", "Mr Commitment"],
    ]);
    minutes.insert("02:29", &[
        &["", "2.28am", ": Ran out of sheep and began counting other farmyard animals.", "Mike Gayle", "Mr Commitment"],
    ]);
    ...
    minutes.insert("02:31", &[
        &["And then I woke up because there were people shouting in the flat and it was ", "2.31am.", " And one of the people was Father and I was frightened.", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("02:32", &[
        &["The last guests departed at ", "2.32 a.m.", ", two hours and two minutes after the scheduled completion time.", "Graeme Simsion", "The Rosie Project"],
    ]);
    ...
    minutes.insert("02:37", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:38", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:39", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:40", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:41", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:42", &[
        &["June 13, 1990. ", "Thirty-seven minutes past two", " in the morning. And sixteen seconds.", "Stephen King", "The Stand"],
    ]);
    minutes.insert("02:43", &[
        &["She settled back beside him. 'It's ", "2:43", ":12am, Case. Got a readout chipped into my optic nerve.'", "William Gibson", "Neuromancer"],
    ]);
    minutes.insert("02:44", &[
        &["She settled back beside him. 'It's ", "2:43", ":12am, Case. Got a readout chipped into my optic nerve.'", "William Gibson", "Neuromancer"],
    ]);
    minutes.insert("02:45", &[
        &["", "0245h", "., Ennet House, the hours that are truly wee.", "David Foster Wallace", "Infinite Jest"],
    ]);
    ...
    minutes.insert("02:56", &[
        &["It was ", "2:56", " when the shovel touched the coffin. We all heard the sound and looked at each other.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    minutes.insert("02:57", &[
        &["It was ", "2:56", " when the shovel touched the coffin. We all heard the sound and looked at each other.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    minutes.insert("02:58", &[
        &["It was ", "2:56", " when the shovel touched the coffin. We all heard the sound and looked at each other.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    ...
    minutes.insert("03:19", &[
        &["The time stamp on Navidson's camcorder indicates that it is exactly ", "3.19 A.M.", "", "Mark Z Danielewski", "House of Leaves"],
    ]);
    minutes.insert("03:20", &[
        &["Prabath Kumara, 16. 17th November 1989. At ", "3.20am", " from the home of a friend.", "Michael Ondaatje", "Anil's Ghost"],
    ]);
    ...
    minutes.insert("03:25", &[
        &["It was ", "3:25 a.m.", " A strange thrill, to think I was the only Mulvaney awake in the house.", "Joyce Carol Oates", "We Were the Mulvaneys"],
    ]);
    minutes.insert("03:26", &[
        &["It was ", "3:25 a.m.", " A strange thrill, to think I was the only Mulvaney awake in the house.", "Joyce Carol Oates", "We Were the Mulvaneys"],
    ]);
    minutes.insert("03:27", &[
        &["It was ", "3:25 a.m.", " A strange thrill, to think I was the only Mulvaney awake in the house.", "Joyce Carol Oates", "We Were the Mulvaneys"],
    ]);
    ...
    minutes.insert("03:34", &[
        &["It was ", "3:34 am.", " and he was wide-awake. He'd heard the phone ring and the sound of his uncle's voice.", "Muriel Jensen", "Always Florence"],
    ]);
    minutes.insert("03:35", &[
        &["He could just see the hands of the alarm clock in the darkness: ", "3.35 a.m.", " He adjusted his pillow and shut his eyes.", "Henning Mankell", "The Dogs of Riga"],
    ]);
    ...
    minutes.insert("03:54", &[
        &["The charter flight from Florida touched down at Aldergrove minutes earlier, at ", "3.54 a.m.", "", "Paul Muldoon", "The More a Man Has, the More a Man Wants"],
    ]);
    minutes.insert("03:55", &[
        &["Here in the cavernous basement at ", "3.55 a.m.", ", in a single pool of light, is Theo Perowne.", "Ian McEwan", "Saturday"],
    ]);
    minutes.insert("03:56", &[
        &["Here in the cavernous basement at ", "3.55 a.m.", ", in a single pool of light, is Theo Perowne.", "Ian McEwan", "Saturday"],
    ]);
    ...
    minutes.insert("04:06", &[
        &["Dexter looked at Kate's note, then her face, then the clock. It was ", "4.06am", ", the night before they would go to the restaurant.", "Chris Pavone", "The Expats"],
    ]);
    ...
    minutes.insert("04:22", &[
        &["He hurt me to the point where I wanted to tell him something. My watch said ", "4.22", " now. It had stopped. It was smashed.", "Len Deighton", "The Ipcress File"],
    ]);
    ...
    minutes.insert("04:31", &[
        &["An earthquake hit Los Angeles at ", "4:31", " this morning and the images began arriving via CNN right away.", "Douglas Coupland", "Microserfs"],
    ]);
    ...
    minutes.insert("04:43", &[
        &["The time is ", "four forty-three", " in the mornin an it's almost light oot there.", "Suhayl Saadi", "Pyschoraag"],
    ]);
    minutes.insert("04:44", &[
        &["The time is ", "four forty-three", " in the mornin an it's almost light oot there.", "Suhayl Saadi", "Pyschoraag"],
    ]);
    ...
    minutes.insert("04:48", &[
        &["At ", "4:48", " the happy hour when clarity visits warm darkness which soaks my eyes I know no sin", "Sarah Kane", "4:48 Psychosis"],
    ]);
    minutes.insert("04:49", &[
        &["At ", "4:48", " the happy hour when clarity visits warm darkness which soaks my eyes I know no sin", "Sarah Kane", "4:48 Psychosis"],
    ]);
    ...
    minutes.insert("05:05", &[
        &["The baby, a boy, is born at ", "five past five", " in the morning.", "Jhumpa Lahiri", "The Namesake"],
    ]);
    ...
    minutes.insert("05:08", &[
        &["Ambrose and I will marry at Fort McHenry at ", "5:08", " EDST this coming Saturday, Rosh Hashanah!", "John Barth", "Letters"],
    ]);
    ...
    minutes.insert("05:11", &[
        &["Today was Tuesday, the fifteenth of August; the sun had risen at ", "eleven minutes past five", " this morning and would set at two minutes before seven this evening.", "Donald E Westlake", "The Hot Rock"],
    ]);
    ...
    minutes.insert("05:25", &[
        &["George's train home from New Street leaves at ", "5.25", ". On the return journey, there are rarely schoolboys.", "Julian Barnes", "Arthur and George"],
    ]);
    ...
    minutes.insert("05:37", &[
        &["Richard glanced at the clock on the microwave - ", "5:37", " - almost twelve hours, almost one half-day since he'd dialed 911.", "AM Homes", "This Book Will Save Your Life"],
    ]);
    ...
    minutes.insert("05:58", &[
        &["Annika Giannini woke with a start. She saw that it was ", "5.58 a.m.", "", "Stieg Larsson", "The Girl who Kicked the Hornet's Nest"],
    ]);
    minutes.insert("05:59", &[
        &["Annika Giannini woke with a start. She saw that it was ", "5.58 a.m.", "", "Stieg Larsson", "The Girl who Kicked the Hornet's Nest"],
    ]);
    ...
    minutes.insert("06:05", &[
        &["A second man went in and found the shop empty, as he thought, at ", "five minutes past six", ". That puts the time at between 5:30 and 6:05.", "Agatha Christie", "The ABC Murders"],
    ]);
    ...
    minutes.insert("06:19", &[
        &["", "6.19 am", ", 8th June 2004, the jet of your pupil set in the gold of your eye.", "Carol Ann Duffy", "Venus"],
    ]);
    ...
    minutes.insert("06:38", &[
        &["The clock on the dashboard said it was ", "6.38am.", " He left the keys in the car, and walked toward the tree.", "Neil Gaiman", "American Gods"],
    ]);
    minutes.insert("06:39", &[
        &["The clock on the dashboard said it was ", "6.38am.", " He left the keys in the car, and walked toward the tree.", "Neil Gaiman", "American Gods"],
    ]);
    ...
    minutes.insert("06:49", &[
        &["Night ends, ", "6:49", ". Meet in the coffee shop at 7:30; press conference at 10:00.", "Hunter S. Thompson", "Fear and Loathing: On the Campaign Trail '72"],
    ]);
    ...
    minutes.insert("07:02", &[
        &["", "07:02", ":18 One and a half hours. 'Case,' she said, 'I wanna favour.'", "William Gibson", "Neuromancer"],
    ]);
    minutes.insert("07:03", &[
        &["", "7:03am", " General Tanz woke up as though aroused by a mental alarm-clock.", "Hans Hellmut Kirst", "The Night of the Generals"],
    ]);
    ...
    minutes.insert("07:08", &[
        &["Reacher had no watch but he figured when he saw Gregory it must have been ", "between eight and nine minutes after seven o'clock", ".", "Lee Child", "The Hard Way"],
    ]);
    ...
    minutes.insert("07:25", &[
        &["", "7.25 a.m.", " clean teeth and wash face", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("07:26", &[
        &["", "7.25 a.m.", " clean teeth and wash face", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("07:27", &[
        &["His appointment with the doctor was for 8.45. It was ", "7.27", ".", "Henning Mankell", "The Return of the Dancing Master"],
    ]);
    minutes.insert("07:28", &[
        &["His appointment with the doctor was for 8.45. It was ", "7.27", ".", "Henning Mankell", "The Return of the Dancing Master"],
    ]);
    minutes.insert("07:29", &[
        &["At ", "7.29", " in the morning of 1 July, the cinematographer finds himself filming silence itself.", "Elizabeth Speller", "At Break of Day"],
    ]);
    ...
    minutes.insert("07:32", &[
        &["At ", "7:32", ", he suffered a fatal stroke.", "Stephen King", "IT"],
    ]);
    minutes.insert("07:33", &[
        &["At ", "7:32", ", he suffered a fatal stroke.", "Stephen King", "IT"],
    ]);
    ...
    minutes.insert("07:35", &[
        &["At ", "7:35am", " Ishigami left his apartment as he did every weekday morning.", "Higashino, Keigo", "The Devotion of Duspect X"],
        &["I looked at my watch. ", "Seven thirty-five", ".", "Kathy Reichs", "Bare Bones"],
    ]);
    minutes.insert("07:36", &[
        &["", "7:36", ", sunrise. The hospital blinds were much better, darker than her own.", "John Ajvide Lindqvist", "Let The Right One In"],
    ]);
    minutes.insert("07:37", &[
        &["", "7:36", ", sunrise. The hospital blinds were much better, darker than her own.", "John Ajvide Lindqvist", "Let The Right One In"],
    ]);
    minutes.insert("07:38", &[
        &["", "7:36", ", sunrise. The hospital blinds were much better, darker than her own.", "John Ajvide Lindqvist", "Let The Right One In"],
    ]);
    ...
    minutes.insert("07:40", &[
        &["", "7.40 a.m.", " Have breakfast.", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("07:41", &[
        &["", "7.40 a.m.", " Have breakfast.", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    ...
    minutes.insert("07:53", &[
        &["\"What time is it?\" \"", "Seven to eight", ". Won't be long now ...\"", "Robert Goddard", "Never go back"],
    ]);
    minutes.insert("07:54", &[
        &["\"What time is it?\" \"", "Seven to eight", ". Won't be long now ...\"", "Robert Goddard", "Never go back"],
    ]);
    minutes.insert("07:55", &[
        &["at ", "7.55", " this morning the circus ran away to join me.", "Roger McGough", "Tightrope, from Selected Poems 1967-1987"],
    ]);
    ...
    minutes.insert("07:59", &[
        &["I'd spent fifty two days in 1958, but here it was ", "7.59", " in the morning.", "Stephen King", "11/22/63"],
    ]);
    ...
    minutes.insert("08:01", &[
        &["", "Eight-one", ", tick-tock, eight-one o'clock, off to school, off to work, run, run, eight-one!", "Ray Bradbury", "There Will Come Soft Rains"],
    ]);
    ...
    minutes.insert("08:05", &[
        &["", "8.05 a.m.", " Pack school bag", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("08:06", &[
        &["", "8.05 a.m.", " Pack school bag", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("08:07", &[
        &["", "8.05 a.m.", " Pack school bag", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("08:08", &[
        &["... every clerk had his particular schedule of hours, which coincided with a single pair of tram runs coming from the city: A had to come in at 8, B at 8:04, C at ", "8:08", " and so on, and the same for quitting times, in such a manner that never would two colleagues have the opportunity to travel in the same tramcar.", "Primo Levi", "The Periodic Table"],
    ]);
    minutes.insert("08:09", &[
        &["He followed the squeals down a hallway. A wall clock read ", "8:09", " - 10:09 Dallas time.", "James Ellroy", "American Tabloid"],
    ]);
...
This last observation applied to the dark gallery, and was indicated by the compass.", "Jules Verne", "A Journey to the Centre of the Earth"],
    ...
    minutes.insert("08:39", &[
        &["Doug McGuire noticed the early hour, ", "8:39 A.M.", " on the one wall clock that gave Daylight Savings Time for the East Coast.", "Winn Schwartau", "Terminal Compromise"],
    ]);
    ...
    minutes.insert("08:47", &[
        &["\"Just on my way to the cottage. It's, er, ..", "8.47", ". Bit misty on the roads.....\"", "Douglas Adams", "Dirk Gently's Holistic Detective Agency"],
        &["", "8.47", ". Bit misty on the roads", "Douglas Adams", "Dirk Gently's Holistic Detective Agency"],
    ]);
    minutes.insert("08:48", &[
        &["\"Just on my way to the cottage. It's, er, ..", "8.47", ". Bit misty on the roads.....\"", "Douglas Adams", "Dirk Gently's Holistic Detective Agency"],
        &["", "8.47", ". Bit misty on the roads", "Douglas Adams", "Dirk Gently's Holistic Detective Agency"],
    ]);
    ...
    minutes.insert("08:51", &[
        &["", "8.51 a.m.", " Arrive at school", "Mark Haddon", "The Curious Incident of the Dog in the Night-time"],
    ]);
    minutes.insert("08:52", &[
        &["Message one. Tuesday, ", "8.52am.", " Is anybody there? Hello?", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    minutes.insert("08:53", &[
        &["Message one. Tuesday, ", "8.52am.", " Is anybody there? Hello?", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    ...
    minutes.insert("08:56", &[
        &["It was ", "nearly nine o'clock", " and the sun was fiercer every minute.'", "George Orwell", "Burmese Days"],
    ]);
    ...
    minutes.insert("09:01", &[
        &["", "9:01am", " lay in bed, staring at ceiling.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:02", &[
        &["", "9:02am", " lay in bed, staring at ceiling.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    ...
    minutes.insert("09:04", &[
        &["", "9:04am", " lay in bed, staring at ceiling", "Steve Toltz", "A Fraction of the Whole"],
        &["In the light of a narrow-beam lantern, Pierce checked his watch. It was ", "9.04", ".", "Michael Crichton", "The Great Train Robbery"],
    ]);
    ...
    minutes.insert("09:06", &[
        &["", "9:06am", " lay in bed, staring at ceiling", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    ...
    minutes.insert("09:08", &[
        &["", "9.08am", " rolled over onto left side.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:09", &[
        &["", "9.09am", " lay in bed, staring at wall.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:10", &[
        &["", "9.10am", " lay in bed, staring at wall.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:11", &[
        &["", "9:11am", " lay in bed, staring at wall", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:12", &[
        &["", "9.12am", " lay in bed, staring at wall.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    ...
    minutes.insert("09:14", &[
        &["", "9.14am", " lay in bed, staring at wall.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    ...
    minutes.insert("09:16", &[
        &["", "9.16am", " sat in bed, staring out window.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:17", &[
        &["", "9.17am", " sat in bed, staring out window.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:18", &[
        &["", "9.18am", " sat in bed, staring out window.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    minutes.insert("09:19", &[
        &["", "9.19am", " sat in bed, staring out window.", "Steve Toltz", "A Fraction of the Whole"],
    ]);
    ...
    minutes.insert("09:21", &[
        &["It was ", "nine twenty-one", ". With one minute to go, there was no sign of Herbert's mother.", "Dan Rhodes", "This is Life"],
    ]);
    ...
    minutes.insert("09:23", &[
        &["", "9.23", ". What possessed me to buy this comb?", "James Joyce", "Ulysses"],
    ]);
    minutes.insert("09:24", &[
        &["", "9.24", " I'm swelled after that cabbage. A speck of dust on the patent leather of her boot.", "James Joyce", "Ulysses"],
    ]);
    ...
    minutes.insert("09:45", &[
        &["9.15, 9.30, ", "9.45", ", 10! Bond felt the excitement ball up inside him like cat's fur.", "Ian Fleming", "On Her Majesty's Secret Service"],
    ]);
    minutes.insert("09:46", &[
        &["9.15, 9.30, ", "9.45", ", 10! Bond felt the excitement ball up inside him like cat's fur.", "Ian Fleming", "On Her Majesty's Secret Service"],
    ]);
    minutes.insert("09:47", &[
        &["Monday February 6th. '", "9.47am.", " Or gone to Las Vegas and got married'.", "Helen Fielding", "Bridget Jones Diary"],
    ]);
    minutes.insert("09:48", &[
        &["Monday February 6th. '", "9.47am.", " Or gone to Las Vegas and got married'.", "Helen Fielding", "Bridget Jones Diary"],
    ]);
    minutes.insert("09:49", &[
        &["Monday February 6th. '", "9.47am.", " Or gone to Las Vegas and got married'.", "Helen Fielding", "Bridget Jones Diary"],
    ]);
    ...
    minutes.insert("10:18", &[
        &["I know that it was ", "10:18", " when I got home because I look at my watch a lot.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    minutes.insert("10:19", &[
        &["I know that it was ", "10:18", " when I got home because I look at my watch a lot.", "Jonathan Safran Foer", "Extremely Loud and Incredibly Close"],
    ]);
    ...
    minutes.insert("10:31", &[
        &["\"If you please. You went to bed at what time, Madame?\" \"", "Just after half past ten.", "\"", "Agatha Christie", "Death on the Nile"],
    ]);
    minutes.insert("10:32", &[
        &["\"If you please. You went to bed at what time, Madame?\" \"", "Just after half past ten.", "\"", "Agatha Christie", "Death on the Nile"],
    ]);
    minutes.insert("10:33", &[
        &["\"If you please. You went to bed at what time, Madame?\" \"", "Just after half past ten.", "\"", "Agatha Christie", "Death on the Nile"],
    ]);
    minutes.insert("10:34", &[
        &["\"If you please. You went to bed at what time, Madame?\" \"", "Just after half past ten.", "\"", "Agatha Christie", "Death on the Nile"],
    ]);
    ...
    minutes.insert("10:40", &[
        &["", "10:40", ": Call from Katharina asking me whether I had really said what was in the News.", "Heinrich Böll", "The Lost Honour of Katharina Blum"],
    ]);
    minutes.insert("10:41", &[
        &["", "10:40", ": Call from Katharina asking me whether I had really said what was in the News.", "Heinrich Böll", "The Lost Honour of Katharina Blum"],
    ]);
    minutes.insert("10:42", &[
        &["", "10:40", ": Call from Katharina asking me whether I had really said what was in the News.", "Heinrich Böll", "The Lost Honour of Katharina Blum"],
    ]);
    ...
    minutes.insert("10:47", &[
        &["He whistles in the shower. It is ", "10.47", " and he is ready for the off.", "Jackie Kay", "Trumpet"],
    ]);
    ...
    minutes.insert("10:55", &[
        &["The clock was still saying ", "five minutes to eleven", " when Pooh and Piglet set out on their way half an hour later.", "AA Milne", "The House at Pooh Corner"],
    ]);
    minutes.insert("10:56", &[
        &["The clock was still saying ", "five minutes to eleven", " when Pooh and Piglet set out on their way half an hour later.", "AA Milne", "The House at Pooh Corner"],
    ]);
    ...
    minutes.insert("10:58", &[
        &["One day Joe was sitting in the office waiting for his 11 o'clock appointment, and at ", "10:58", " this black gal came in.", "Helen DeWitt", "Lightning Rods"],
    ]);
    ...
    minutes.insert("11:18", &[
        &["It is ", "11.18", ". A row of bungalows in a round with a clump of larch tree in the middle.", "Jackie Kay", "Trumpet"],
    ]);
    ...
    minutes.insert("11:27", &[
        &["It's from one of the more recent plates the tree has scanned: ", "11.27", " in the morning of 4 April 1175", "Chris James", "The Second Internet Cafe, Part 2: The Cascade Annihilator"],
    ]);
    ...
    minutes.insert("11:48", &[
        &["At 11:38, she left her desk and walked to the side door of the auditorium, arriving ", "ten minutes before noon", ".", "Dave Eggers", "The Circle"],
    ]);
    minutes.insert("11:49", &[
        &["At 11:38, she left her desk and walked to the side door of the auditorium, arriving ", "ten minutes before noon", ".", "Dave Eggers", "The Circle"],
    ]);
    ...
    minutes.insert("11:54", &[
        &["He swilled off the remains of [his beer] and looked at the clock. It was ", "six minutes to twelve", ".", "Patrick Hamilton", "Hangover Square"],
    ]);
    ...
    minutes.insert("11:59", &[
        &["There is a big grandfather clock there, and as the hands drew ", "near to twelve", " I don't mind confessing I was as nervous as a cat.", "Agatha Christie", "The Adventure of Johnnie Waverley: A Hercule Poirot Story"],
    ]);
    ...
    minutes.insert("12:08", &[
        &["When a clock struck noon in Washington, D.C., the time was ", "12:08", " in Philadephia, 12:12 in new York, and 12:24 in Boston.", "Matthew Goodman", "Eighty Days"],
    ]);
    minutes.insert("12:09", &[
        &["When a clock struck noon in Washington, D.C., the time was ", "12:08", " in Philadephia, 12:12 in new York, and 12:24 in Boston.", "Matthew Goodman", "Eighty Days"],
    ]);
    ...
    minutes.insert("12:14", &[
        &["She left London on the ", "twelve-fourteen", " from Paddington, arriving at Bristol (where she had to change) at two-fifty.", "Agatha Christie", "The Plymouth Express"],
    ]);
    ...
    minutes.insert("12:21", &[
        &["Jake think of something. PLEASE! ", "Twelve twenty-one", ".", "Stephen King", "11/22/63"],
    ]);
    ...
    minutes.insert("12:25", &[
        &["Boys, do it now. God's time is ", "12.25", ".", "James Joyce", "Ulysses"],
    ]);
    minutes.insert("12:26", &[
        &["12.25pm. ", "26.", " 27. Every time Billy saved a shot he looked heartbroken", "Barry Hines", "A Kestrel For a Knave"],
    ]);
    minutes.insert("12:27", &[
        &["12.25pm. 26. ", "27.", " Every time Billy saved a shot he looked heartbroken", "Barry Hines", "A Kestrel For a Knave"],
    ]);
    minutes.insert("12:28", &[
        &["The DRINK CHEER-UP COFFEE wall clock read ", "12.28", ".", "Stephen King", "11/22/63"],
    ]);
    minutes.insert("12:29", &[
        &["The DRINK CHEER-UP COFFEE wall clock read ", "12.28", ".", "Stephen King", "11/22/63"],
    ]);
    ...
    minutes.insert("12:33", &[
        &["It's ", "12.33", " now and I could do it, the station is just down that side road there.", "Dorothy L. Sayers", "Five Red Herrings"],
    ]);
    minutes.insert("12:34", &[
        &["It's ", "12.33", " now and I could do it, the station is just down that side road there.", "Dorothy L. Sayers", "Five Red Herrings"],
    ]);
    ...
    minutes.insert("12:49", &[
        &["The first victim of the Krefeld raid died at ", "12:49 hours", " Double British Summer Time at B Flight, but it wasn't due to carelessness.", "Len Deighton", "Bomber"],
    ]);
    ...
    minutes.insert("12:52", &[
        &["The nightclub stood on the junction, flamboyant, still. It was ", "12.52", ".", "Rupert Thomson", "Dreams of Leaving"],
    ]);
    minutes.insert("12:53", &[
        &["Aboot twelve miles. We ought tae pass her at Pinmore. She's due there at ", "12:53", ".", "Dorothy L. Sayers", "Five Red Herrings"],
    ]);
    ...
    minutes.insert("12:55", &[
        &["The inspector glanced at the clock. ", "Five to one", ". A busy morning.", "Ngaio Marsh", "A Man Lay Dead"],
    ]);
    minutes.insert("12:56", &[
        &["The inspector glanced at the clock. ", "Five to one", ". A busy morning.", "Ngaio Marsh", "A Man Lay Dead"],
    ]);
    minutes.insert("12:57", &[
        &["The inspector glanced at the clock. ", "Five to one", ". A busy morning.", "Ngaio Marsh", "A Man Lay Dead"],
    ]);
    minutes.insert("12:58", &[
        &["The watch on my wrist showed ", "12.58pm", " I'd have time to hit the morgue.", "Ilona Andrews", "Magic Bites"],
    ]);
    minutes.insert("12:59", &[
        &["And I had been looking at my watch since the train had started at ", "12.59pm", "", "Mark Haddon", "The Curious Incident of the Dog in the Night-Time"],
    ]);
    ...
    minutes.insert("13:02", &[
        &["At ", "about one o'clock", " the overseer arrived and told them he had no jobs for them", "George Orwell", "A Clergyman's Daughter"],
    ]);
    ...
    minutes.insert("13:06", &[
        &["And then at precisely ", "13 hours and 6 minutes", " - confusion broke out in the rectangle.", "Yevgeny Zamyatin", "We"],
    ]);
    minutes.insert("13:07", &[
        &["And then at precisely ", "13 hours and 6 minutes", " - confusion broke out in the rectangle.", "Yevgeny Zamyatin", "We"],
    ]);
    minutes.insert("13:08", &[
        &["And then at precisely ", "13 hours and 6 minutes", " - confusion broke out in the rectangle.", "Yevgeny Zamyatin", "We"],
    ]);
    ...
    minutes.insert("13:10", &[
        &["\"It was ", "ten minutes past one", ".” “You are sure of that?\"", "Agatha Christie", "Death on the Nile"],
    ]);
    ...
    minutes.insert("13:16", &[
        &["And the first stop had been at ", "1.16pm", " which was 17 minutes later.", "Mark Haddon", "The Curious Incident of the Dog in the Night-Time"],
    ]);
    ...
    minutes.insert("13:24", &[
        &["Littell checked his watch - ", "1:24 p.m", " - Littell grabbed the phone by the bed.", "James Ellroy", "The Cold Six Thousand"],
    ]);
    ...
    minutes.insert("13:42", &[
        &["The last note was recorded at ", "1.42pm", ": G.M. on site at H-by; will take over the matter.", "Stieg Larsson", "The Girl with the Dragon Tattoo"],
    ]);
    minutes.insert("13:43", &[
        &["The last note was recorded at ", "1.42pm", ": G.M. on site at H-by; will take over the matter.", "Stieg Larsson", "The Girl with the Dragon Tattoo"],
    ]);
    minutes.insert("13:44", &[
        &["By good luck, the next train was due at ", "forty-four minutes past one", ", and arrived at Yateland (the next station) ten minutes afterward.", "Wilkie Collins", "Mr. Policeman and the Cook"],
    ]);
    ...
    minutes.insert("13:49", &[
        &["The bookstall clerk had seen the passenger in grey pass the bookstall at ", "1.49", ", in the direction of the exit.", "Dorothy L. Sayers", "Five Red Herrings"],
    ]);
    ...
    minutes.insert("13:57", &[
        &["I looked for a clock. It was ", "three minutes to two", ". \"I hope you can catch him, then. Thank you. I really appreciate it.\"", "C.E. Murphy", "Urban Shaman"],
    ]);
    ...
    minutes.insert("14:06", &[
        &["A man driving a tractor saw her, four hundred yards from her house, ", "six minutes past two", " in the afternoon.", "Hilary Mantel", "A Change of Climate"],
    ]);
    minutes.insert("14:07", &[
        &["A man driving a tractor saw her, four hundred yards from her house, ", "six minutes past two", " in the afternoon.", "Hilary Mantel", "A Change of Climate"],
    ]);
    minutes.insert("14:08", &[
        &["A man driving a tractor saw her, four hundred yards from her house, ", "six minutes past two", " in the afternoon.", "Hilary Mantel", "A Change of Climate"],
    ]);
    minutes.insert("14:09", &[
        &["A man driving a tractor saw her, four hundred yards from her house, ", "six minutes past two", " in the afternoon.", "Hilary Mantel", "A Change of Climate"],
    ]);
    ...
    minutes.insert("14:13", &[
        &["At the third stroke, it will be ", "two ... thirteen", " ... and fifty seconds.'", "Douglas Adams", "So Long, and Thanks for All the Fish"],
    ]);
    minutes.insert("14:14", &[
        &["At the third stroke, it will be ", "two ... thirteen", " ... and fifty seconds.'", "Douglas Adams", "So Long, and Thanks for All the Fish"],
    ]);
    ...
    minutes.insert("14:36", &[
        &["I look at my watch. ", "Two thirty-six", ". All I've got left today is take in the laundry and fix dinner.", "Haruki Murakami", "The Elephant Vanishes"],
    ]);
    minutes.insert("14:37", &[
        &["I look at my watch. ", "Two thirty-six", ". All I've got left today is take in the laundry and fix dinner.", "Haruki Murakami", "The Elephant Vanishes"],
    ]);
    minutes.insert("14:38", &[
        &["I look at my watch. ", "Two thirty-six", ". All I've got left today is take in the laundry and fix dinner.", "Haruki Murakami", "The Elephant Vanishes"],
    ]);
    ...
    minutes.insert("15:04", &[
        &["Woken at ", "1504", " by Michelangelo hammering away with his chisel.", "Hallgrímur Helgason", "101 Reykjavik"],
    ]);
    ...
    minutes.insert("15:09", &[
        &["On the next day he boarded the London train which reaches Hull at ", "3.09", ". At Paragon Station he soon singled out Beamish from Merriman's description.", "Freeman Wills Crofts", "The Pit-Prop Syndicate"],
    ]);
    minutes.insert("15:10", &[
        &["This time it was only the simple fact that the hands chanced to point to ", "3.10pm", ", the precise moment at which all the clocks of London had stopped.", "M.P. Shiel", "The Purple Cloud"],
    ]);
    minutes.insert("15:11", &[
        &["This time it was only the simple fact that the hands chanced to point to ", "3.10pm", ", the precise moment at which all the clocks of London had stopped.", "M.P. Shiel", "The Purple Cloud"],
    ]);
    minutes.insert("15:12", &[
        &["This time it was only the simple fact that the hands chanced to point to ", "3.10pm", ", the precise moment at which all the clocks of London had stopped.", "M.P. Shiel", "The Purple Cloud"],
    ]);
    ...
    minutes.insert("15:16", &[
        &["The Nimrod rendezvoused with the light aircraft at ", "1516", " GMT.", "Iain Banks", "The Crow Road"],
    ]);
    minutes.insert("15:17", &[
        &["The Nimrod rendezvoused with the light aircraft at ", "1516", " GMT.", "Iain Banks", "The Crow Road"],
    ]);
    minutes.insert("15:18", &[
        &["The Nimrod rendezvoused with the light aircraft at ", "1516", " GMT.", "Iain Banks", "The Crow Road"],
    ]);
    minutes.insert("15:19", &[
        &["The Nimrod rendezvoused with the light aircraft at ", "1516", " GMT.", "Iain Banks", "The Crow Road"],
    ]);
    ...
    minutes.insert("15:27", &[
        &["And she rang the Reverend Peters and he came into school at ", "3.27pm", " and he said, 'So, young man, are we ready to roll?'", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    minutes.insert("15:28", &[
        &["And she rang the Reverend Peters and he came into school at ", "3.27pm", " and he said, 'So, young man, are we ready to roll?'", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    ...
    minutes.insert("15:33", &[
        &["I picked up my briefcase, glancing at my watch again as I did so. ", "Three thirty-three", ".", "Stephen King", "11/22/63"],
    ]);
    minutes.insert("15:34", &[
        &["I picked up my briefcase, glancing at my watch again as I did so. ", "Three thirty-three", ".", "Stephen King", "11/22/63"],
    ]);
    ...
    minutes.insert("15:50", &[
        &["", "3.50 p.m.", " Have juice and snack", "Mark Haddon", "The Curious Incident Of The Dog In The Night-Time"],
    ]);
    ...
    minutes.insert("15:55", &[
        &["", "3.55 p.m.", " Give Toby food and water", "Mark Haddon", "The Curious Incident of the Dog in the Night-time"],
    ]);
    minutes.insert("15:56", &[
        &["", "Four minutes to four", ". Newman sighed again, lost in thought.", "Lee Child", "Tripwire"],
    ]);
    ...
    minutes.insert("16:03", &[
        &["She read the page carefully and then said, '", "16.03", " - cat goes to the toilet in front garden.'", "Catherine O'Flynn", "What was Lost"],
    ]);
    ...
    minutes.insert("16:08", &[
        &["It was ", "eight minutes after four", ". I still don't have a plan. Maybe the guys in the Nova, maybe they had a plan.", "Robert Crais", "The Monkey's Raincoat"],
    ]);
    ...
    minutes.insert("16:18", &[
        &["", "4.18 p.m.", " Put Toby into his cage", "Mark Haddon", "The Curious Incident of the Dog in the Night-time"],
    ]);
    ...
    minutes.insert("17:14", &[
        &["\"Do you know what time it is, Atticus?\" she said. \"Exactly ", "fourteen minutes past five", ". The alarm clock's set for five-thirty. I want you to know that.\"", "Harper Lee", "To Kill a Mockingbird"],
    ]);
    ...
    minutes.insert("17:50", &[
        &["\"What time is it Jack?\" \"", "Ten to six", "\"\"Ten more minutes then.\" I shuffle the cards. \"Time for a quick game of rummy?\"", "Malorie Blackman", "Noughts and Crosses"],
    ]);
    minutes.insert("17:51", &[
        &["\"What time is it Jack?\" \"", "Ten to six", "\"\"Ten more minutes then.\" I shuffle the cards. \"Time for a quick game of rummy?\"", "Malorie Blackman", "Noughts and Crosses"],
    ]);
    minutes.insert("17:52", &[
        &["\"What time is it Jack?\" \"", "Ten to six", "\"\"Ten more minutes then.\" I shuffle the cards. \"Time for a quick game of rummy?\"", "Malorie Blackman", "Noughts and Crosses"],
    ]);
    ...
    minutes.insert("18:05", &[
        &["At about ", "five past six", " Piers came in carrying an evening paper and a few books.", "Barbara Pym", "A Glass of Blessings"],
    ]);
    minutes.insert("18:06", &[
        &["At about ", "five past six", " Piers came in carrying an evening paper and a few books.", "Barbara Pym", "A Glass of Blessings"],
    ]);
    minutes.insert("18:07", &[
        &["At about ", "five past six", " Piers came in carrying an evening paper and a few books.", "Barbara Pym", "A Glass of Blessings"],
    ]);
    minutes.insert("18:08", &[
        &["", "6:08 p.m.", " The code-word \"Valkyrie\" reached von Seydlitz Gabler's headquarters", "Hans Hellmut Kirst", "The Night of the Generals"],
    ]);
    minutes.insert("18:09", &[
        &["", "6:08 p.m.", " The code-word \"Valkyrie\" reached von Seydlitz Gabler's headquarters", "Hans Hellmut Kirst", "The Night of the Generals"],
    ]);
    ...
    minutes.insert("18:15", &[
        &["'", "Quarter past six", ",' said Tony. 'He's bound to have told her by now.'", "Evelyn Waugh", "A Handful of Dust"],
        &["At a ", "quarter past six", " he was through with them.", "Penelope Lively", "The Photograph"],
        &["I checked the time on the corner of my screen. ", "6.15 pm.", " I was never going to finisah my essay in forty-five minutes", "Sophie McKenzie", "Girl Missing"],
    ]);
    minutes.insert("18:16", &[
        &["'", "Quarter past six", ",' said Tony. 'He's bound to have told her by now.'", "Evelyn Waugh", "A Handful of Dust"],
        &["At a ", "quarter past six", " he was through with them.", "Penelope Lively", "The Photograph"],
        &["I checked the time on the corner of my screen. ", "6.15 pm.", " I was never going to finisah my essay in forty-five minutes", "Sophie McKenzie", "Girl Missing"],
    ]);
    minutes.insert("18:17", &[
        &["'", "Quarter past six", ",' said Tony. 'He's bound to have told her by now.'", "Evelyn Waugh", "A Handful of Dust"],
        &["At a ", "quarter past six", " he was through with them.", "Penelope Lively", "The Photograph"],
        &["I checked the time on the corner of my screen. ", "6.15 pm.", " I was never going to finisah my essay in forty-five minutes", "Sophie McKenzie", "Girl Missing"],
    ]);
    minutes.insert("18:18", &[
        &["'", "Quarter past six", ",' said Tony. 'He's bound to have told her by now.'", "Evelyn Waugh", "A Handful of Dust"],
        &["At a ", "quarter past six", " he was through with them.", "Penelope Lively", "The Photograph"],
        &["I checked the time on the corner of my screen. ", "6.15 pm.", " I was never going to finisah my essay in forty-five minutes", "Sophie McKenzie", "Girl Missing"],
    ]);
    minutes.insert("18:19", &[
        &["'", "Quarter past six", ",' said Tony. 'He's bound to have told her by now.'", "Evelyn Waugh", "A Handful of Dust"],
        &["At a ", "quarter past six", " he was through with them.", "Penelope Lively", "The Photograph"],
        &["I checked the time on the corner of my screen. ", "6.15 pm.", " I was never going to finisah my essay in forty-five minutes", "Sophie McKenzie", "Girl Missing"],
    ]);
    minutes.insert("18:20", &[
        &["By the time Elliot's mother arrived at ", "twenty past six", ", Mrs Sen always made sure all evidence of her chopping was disposed of.", "Jhumpa Lahiri", "Interpreter of Maladies"],
    ]);
    ...
    minutes.insert("18:22", &[
        &["Clock overturned when he fell forward. That'll give us the time of the crime. ", "Twenty-two minutes past six", ".", "Agatha Christie", "The Murder at the Vicarage"],
    ]);
    minutes.insert("18:23", &[
        &["Clock overturned when he fell forward. That'll give us the time of the crime. ", "Twenty-two minutes past six", ".", "Agatha Christie", "The Murder at the Vicarage"],
    ]);
    minutes.insert("18:24", &[
        &["Clock overturned when he fell forward. That'll give us the time of the crime. ", "Twenty-two minutes past six", ".", "Agatha Christie", "The Murder at the Vicarage"],
    ]);
    ...
    minutes.insert("18:31", &[
        &["I had been delayed at a case and it was ", "a little after half past six", " when I found myself at Baker Street once more", "Arthur Conan Doyle", "The Adventure of The Blue Carbuncle"],
    ]);
    ...
    minutes.insert("18:49", &[
        &["", "6:49 p.m.", " Lieutenant-General Tanz escorted by a motorized unit, drove to Corps headquarters", "Hans Hellmut Kirst", "The Night of the Generals"],
    ]);
    ...
    minutes.insert("18:51", &[
        &["The square of light in the kitchen doorway had faded to thin purple; his watch said ", "6:51", ".", "Stephen King", "Salem's Lot"],
    ]);
    minutes.insert("18:52", &[
        &["The square of light in the kitchen doorway had faded to thin purple; his watch said ", "6:51", ".", "Stephen King", "Salem's Lot"],
    ]);
    ...
    minutes.insert("19:01", &[
        &["He waited until nearly eight, because ", "around seven", " there were always more people coming in and out of the house than at other times.", "Patricia Highsmith", "The Talented Mr Ripley"],
    ]);
    ...
    minutes.insert("19:16", &[
        &["“", "Sixteen past seven PM", "? That's when he came into the store or when he left after the fact?”", "Patricia Cornwell", "The Last Precinct"],
    ]);
    ...
    minutes.insert("19:35", &[
        &["", "7.35", "-40. Yseut arrives at 'M. and S.', puts through phone call.", "Edmund Crispin", "The Case of the Gilded Fly"],
    ]);
    minutes.insert("19:36", &[
        &["", "7.35", "-40. Yseut arrives at 'M. and S.', puts through phone call.", "Edmund Crispin", "The Case of the Gilded Fly"],
    ]);
    minutes.insert("19:37", &[
        &["", "7.35", "-40. Yseut arrives at 'M. and S.', puts through phone call.", "Edmund Crispin", "The Case of the Gilded Fly"],
    ]);
    minutes.insert("19:38", &[
        &["", "7.35", "-40. Yseut arrives at 'M. and S.', puts through phone call.", "Edmund Crispin", "The Case of the Gilded Fly"],
    ]);
    minutes.insert("19:39", &[
        &["", "7.35", "-40. Yseut arrives at 'M. and S.', puts through phone call.", "Edmund Crispin", "The Case of the Gilded Fly"],
    ]);
    ...
    minutes.insert("19:58", &[
        &["Robert Langdon stole an anxious glance at his wristwatch: ", "7.58pm.", " The smiling face of Mickey Mouse did little to cheer him up.", "Dan Brown", "The Lost Symbol"],
    ]);
    ...
    minutes.insert("20:01", &[
        &["It was only ", "a little after eight o'clock", ", so all the shows were about silliness or murder.", "Kurt Vonnegut", "Slaughterhouse 5"],
    ]);
    ...
    minutes.insert("20:24", &[
        &["Peach checked his watch. ", "8.24.", " If he wasn't in a taxi in twenty minutes he'd be done for.", "Rupert Thomson", "Dreams of Leaving"],
    ]);
    ...
    minutes.insert("20:36", &[
        &["", "20.36", " Rimmer stood in the main wash-room on the stasis deck and combed his hair.", "Grant Naylor", "Red Dwarf"],
    ]);
    minutes.insert("20:37", &[
        &["", "20.36", " Rimmer stood in the main wash-room on the stasis deck and combed his hair.", "Grant Naylor", "Red Dwarf"],
    ]);
    minutes.insert("20:38", &[
        &["", "20.36", " Rimmer stood in the main wash-room on the stasis deck and combed his hair.", "Grant Naylor", "Red Dwarf"],
    ]);
    minutes.insert("20:39", &[
        &["", "20.36", " Rimmer stood in the main wash-room on the stasis deck and combed his hair.", "Grant Naylor", "Red Dwarf"],
    ]);
    ...
    minutes.insert("20:46", &[
        &["At the tone, the time will be ", "eight forty six", ", exactly. One cubic mile of seawater contains about 50 pounds of gold.", "Tom Lichtenberg", "Macedonia"],
    ]);
    minutes.insert("20:47", &[
        &["At the tone, the time will be ", "eight forty six", ", exactly. One cubic mile of seawater contains about 50 pounds of gold.", "Tom Lichtenberg", "Macedonia"],
    ]);
    minutes.insert("20:48", &[
        &["At the tone, the time will be ", "eight forty six", ", exactly. One cubic mile of seawater contains about 50 pounds of gold.", "Tom Lichtenberg", "Macedonia"],
    ]);
    ...
    minutes.insert("20:56", &[
        &["“No. 7 berth—a second-class. The gentleman has not yet come, and it is ", "four minutes to nine", ".\"", "Agatha Christie", "Murder on the Orient Express"],
    ]);
    ...
    minutes.insert("20:58", &[
        &["\"What time is it?\" she asked, quiet, definite, hopeless. \"", "Two minutes to nine", ",\" he replied, telling the truth with a struggle.", "D H Lawrence", "Sons and Lovers"],
    ]);
    minutes.insert("20:59", &[
        &["\"What time is it?\" she asked, quiet, definite, hopeless. \"", "Two minutes to nine", ",\" he replied, telling the truth with a struggle.", "D H Lawrence", "Sons and Lovers"],
    ]);
    ...
    minutes.insert("21:09", &[
        &["", "9.09", ". Too late to turn around and go back. Too late, too dangerous.", "Rupert Thomson", "Dreams of Leaving"],
    ]);
    minutes.insert("21:10", &[
        &["", "9.09", ". Too late to turn around and go back. Too late, too dangerous.", "Rupert Thomson", "Dreams of Leaving"],
    ]);
    ...
    minutes.insert("21:20", &[
        &["", "9.20 p.m.", " Have juice and a snack", "Mark Haddon", "The Curious Incident of the Dog in the Night-time"],
    ]);
    minutes.insert("21:21", &[
        &["", "9.20 p.m.", " Have juice and a snack", "Mark Haddon", "The Curious Incident of the Dog in the Night-time"],
    ]);
    ...
    minutes.insert("21:28", &[
        &["From that moment on--", "9:28", " in the evening, June 18, 1941--everything was different.", "Jonathan Safran Foer", "Everything is Illuminated"],
    ]);
    minutes.insert("21:29", &[
        &["From that moment on--", "9:28", " in the evening, June 18, 1941--everything was different.", "Jonathan Safran Foer", "Everything is Illuminated"],
    ]);
    ...
    minutes.insert("21:35", &[
        &["The Sergeant jotted it down on a piece of paper. 'That checks up with his own story: ", "9.35 p.m.", " Budd leaves; the North dame arrives.'", "Georgette Heyer", "A Blunt Instrument"],
    ]);
    ...
    minutes.insert("21:42", &[
        &["Langdon looked at his Mickey Mouse watch. ", "9:42 P.M.", "", "Dan Brown", "The Lost Symbol"],
    ]);
    minutes.insert("21:43", &[
        &["Langdon looked at his Mickey Mouse watch. ", "9:42 P.M.", "", "Dan Brown", "The Lost Symbol"],
    ]);
    minutes.insert("21:44", &[
        &["Langdon looked at his Mickey Mouse watch. ", "9:42 P.M.", "", "Dan Brown", "The Lost Symbol"],
    ]);
    ...
    minutes.insert("21:47", &[
        &["For Hunter, who was trained to note times exactly, the final emergency started at ", "thirteen minutes to ten", ".", "CJ Driver", "Elegy for a Revolutionary"],
    ]);
    minutes.insert("21:48", &[
        &["For Hunter, who was trained to note times exactly, the final emergency started at ", "thirteen minutes to ten", ".", "CJ Driver", "Elegy for a Revolutionary"],
    ]);
    minutes.insert("21:49", &[
        &["For Hunter, who was trained to note times exactly, the final emergency started at ", "thirteen minutes to ten", ".", "CJ Driver", "Elegy for a Revolutionary"],
    ]);
    minutes.insert("21:50", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:51", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:52", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:53", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:54", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:55", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    minutes.insert("21:56", &[
        &["I passed out on to the road and saw by the lighted dial of a clock that it was ", "ten minutes to ten", ". In front of me was a large building which displayed the magical name.", "James Joyce", "Dubliners"],
    ]);
    ...
    minutes.insert("22:02", &[
        &["It was now ", "10.02pm.", " He has less than two hours.", "Dan Brown", "The Lost Symbol"],
    ]);
    minutes.insert("22:03", &[
        &["It was now ", "10.02pm.", " He has less than two hours.", "Dan Brown", "The Lost Symbol"],
    ]);
    minutes.insert("22:04", &[
        &["It was now ", "10.02pm.", " He has less than two hours.", "Dan Brown", "The Lost Symbol"],
    ]);
    ...
    minutes.insert("22:15", &[
        &["", "10:15 p.m.", " Aargh Newsnight on in 15 minutes", "Helen Fielding", "Bridget Jones's Diary"],
    ]);
    minutes.insert("22:16", &[
        &["", "10:15 p.m.", " Aargh Newsnight on in 15 minutes", "Helen Fielding", "Bridget Jones's Diary"],
    ]);
    minutes.insert("22:17", &[
        &["", "10:17 p. m.", " Casette will not go in", "Helen Fielding", "Bridget Jones's Diary"],
    ]);
    ...
    minutes.insert("23:12", &[
        &["There was a confirmatory identification done by undercover officer 6475 at ", "23:12", " hours at the corner of 147th and Amsterdam.", "Sergio De La Pava", "A Naked Singularity"],
    ]);
    minutes.insert("23:13", &[
        &["There was a confirmatory identification done by undercover officer 6475 at ", "23:12", " hours at the corner of 147th and Amsterdam.", "Sergio De La Pava", "A Naked Singularity"],
    ]);
    minutes.insert("23:14", &[
        &["There was a confirmatory identification done by undercover officer 6475 at ", "23:12", " hours at the corner of 147th and Amsterdam.", "Sergio De La Pava", "A Naked Singularity"],
    ]);
    ...
    minutes.insert("23:49", &[
        &["Tom shrugged. He pushed his pinkish ruffled sleeve back, and saw that it was ", "eleven minutes to midnight", ". Tom finished his coffee.", "The Patricia Highsmith", "The Boy Who Followed Ripley"],
    ]);
